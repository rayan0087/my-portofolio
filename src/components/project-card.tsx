...
export function ProjectCard({
  ...
  return (
    <div
      ...
      className={cn(
        "flex flex-col h-full bg-card text-card-foreground border border-border rounded-xl overflow-hidden hover:ring-2 cursor-pointer hover:ring-muted transition-all duration-200 group/card",
        className
      )}
    >
